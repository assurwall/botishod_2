...
def increment_buttons_db(button_id):
    ...
    cur.execute("INSERT INTO statistics_buttons (date, hl, inf, cn, ln, lg) VALUES ('26-11-2018',"+str(value[1])+","+str(value[2])+","+str(value[3])+","+str(value[4])+","+str(value[5])+") ON CONFLICT (date) DO UPDATE SET hl="+str(value[1])+", inf="+str(value[2])+", cn="+str(value[3])+", ln="+(value[4])+",lg="+str(value[5]))
